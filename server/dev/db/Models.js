...
var Post = function Post(_ref) {
    var _ref$title = _ref.title,
        ...
        _ref$userSynopsis = _ref.userSynopsis,
        userSynopsis = _ref$userSynopsis === undefined ? {} : _ref$userSynopsis,
        _ref$date = _ref.date,
        date = _ref$date === undefined ? new Date().toLocaleDateString() : _ref$date,
        _ref$time = _ref.time,
...
var UserSynopsis = function UserSynopsis(_ref2) {
    var _ref2$username = _ref2.username,
        username = _ref2$username === undefined ? '' : _ref2$username,
        _ref2$nickname = _ref2.nickname,
        nickname = _ref2$nickname === undefined ? '' : _ref2$nickname,
        _ref2$avatar = _ref2.avatar,
        avatar = _ref2$avatar === undefined ? '' : _ref2$avatar;

    _classCallCheck(this, UserSynopsis);
...
var Comment = function Comment(_ref4) {
    var _ref4$userSynopsis = _ref4.userSynopsis,
        userSynopsis = _ref4$userSynopsis === undefined ? {} : _ref4$userSynopsis,
        _ref4$date = _ref4.date,
        date = _ref4$date === undefined ? new Date().toLocaleDateString() : _ref4$date,
        _ref4$time = _ref4.time,
        time = _ref4$time === undefined ? Date.now() : _ref4$time,
        _ref4$text = _ref4.text,
        text = _ref4$text === undefined ? '' : _ref4$text;
